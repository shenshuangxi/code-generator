package com.gz.platform.generator.rest;
...
import com.gz.platform.generator.msg.TableResultResponse;
import com.gz.platform.generator.service.GeneratorService;
...
public class GeneratorRest {
    ...
    public void code(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        response.reset();
        response.setHeader("Content-Disposition", "attachment; filename=\"gz-platform-code.zip\"");
